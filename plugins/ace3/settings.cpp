...
#define ACE3_SETTINGS_REVIVE_TIME		600		//seconds, time until death
...
#define ACE3_PARAM_MED_LEVEL 			2		//1 - basic/2 - advanced (PARAM)
#define ACE3_PARAM_MED_PLAYER_HEALTH	3		//Player health (PARAM)
#define ACE3_PARAM_MED_INSTADEATH		1		//true, enable instedeath
// MEDICAL
...
#define ACE3_SETTINGS_MED_BLEED			0.5		//Bleeding coef. (lower than 1 to bleed slower)
#define ACE3_SETTINGS_MED_PAIN			0.75		//Pain coef. (lower than 1 for less pain)
// ADVANCED
#define ACE3_SETTINGS_ADV_WOUNDS		true	//Enable advanced woudns?(wound reopening)
#define ACE3_SETTINGS_ADV_PAK_CONSUME	0		//0, to not, 1 to Consume PAK on use
#define ACE3_SETTINGS_ADV_WOUNDS		true	//Enable advanced woudns?(wound reopening)
#define ACE3_SETTINGS_ADV_HITPOINTS		false	//Heal hitpoints with bandages? (also done by surgical kits with rgd ace3)
// CUSTOM
#define ACE3_SETTINGS_LEGSFIX			true	//Allow players to splint legs
